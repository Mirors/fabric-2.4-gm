		...
		channelCache = &lifecycle.ChannelCache{
			Chaincodes: map[string]*lifecycle.CachedChaincodeDefinition{
				"chaincode-name": {
					...
					Approved: true,
					Hashes: []string{
						string(util.ComputeSM3([]byte("namespaces/metadata/chaincode-name#3"))),
						string(util.ComputeSM3([]byte("namespaces/fields/chaincode-name#3/Sequence"))),
						string(util.ComputeSM3([]byte("namespaces/fields/chaincode-name#3/EndorsementInfo"))),
						string(util.ComputeSM3([]byte("namespaces/fields/chaincode-name#3/ValidationInfo"))),
						string(util.ComputeSM3([]byte("namespaces/fields/chaincode-name#3/Collections"))),
						string(util.ComputeSM3([]byte("chaincode-sources/fields/chaincode-name#3/PackageID"))),
					},
				},
			},
			InterestingHashes: map[string]string{
				string(util.ComputeSM3([]byte("namespaces/metadata/chaincode-name#3"))):                "chaincode-name",
				string(util.ComputeSM3([]byte("namespaces/fields/chaincode-name#3/Sequence"))):         "chaincode-name",
				string(util.ComputeSM3([]byte("namespaces/fields/chaincode-name#3/EndorsementInfo"))):  "chaincode-name",
				string(util.ComputeSM3([]byte("namespaces/fields/chaincode-name#3/ValidationInfo"))):   "chaincode-name",
				string(util.ComputeSM3([]byte("namespaces/fields/chaincode-name#3/Collections"))):      "chaincode-name",
				string(util.ComputeSM3([]byte("chaincode-sources/fields/chaincode-name#3/PackageID"))): "chaincode-name",
			},
		}

		localChaincodes = map[string]*lifecycle.LocalChaincode{
			string(util.ComputeSM3(protoutil.MarshalOrPanic(&lb.StateData{
	...
	Describe("Initialize", func() {
		...
		It("sets the definitions from the state", func() {
			...
			Expect(channelCache.Chaincodes["chaincode-name"].Hashes).To(Equal([]string{
				string(util.ComputeSM3([]byte("namespaces/metadata/chaincode-name#7"))),
				string(util.ComputeSM3([]byte("namespaces/fields/chaincode-name#7/EndorsementInfo"))),
				string(util.ComputeSM3([]byte("namespaces/fields/chaincode-name#7/ValidationInfo"))),
				string(util.ComputeSM3([]byte("namespaces/fields/chaincode-name#7/Collections"))),
				string(util.ComputeSM3([]byte("chaincode-sources/fields/chaincode-name#7/PackageID"))),
			}))
			...
			Context("when the update is to private data", func() {
				BeforeEach(func() {
					...
					trigger.StateUpdates["_lifecycle"].CollHashUpdates["_implicit_org_my-mspid"] = []*kvrwset.KVWriteHash{
						{KeyHash: util.ComputeSM3([]byte("namespaces/fields/chaincode-name#3/EndorsementInfo"))},
					}
				})
		...
		Context("when new chaincode becomes available", func() {
						...
						"_lifecycle": {
							...
							CollHashUpdates: map[string][]*kvrwset.KVWriteHash{
								"_implicit_org_my-mspid": {
									{
										KeyHash: util.ComputeSM3([]byte("namespaces/fields/chaincode-name-1#1/EndorsementInfo")),
									},
								},
							},
						},
			...
			Context("when chaincode definition is updated by the sequence of events install, approve, and define for existing chaincode name", func() {
				BeforeEach(func() {
					...
					approvalTrigger.StateUpdates["_lifecycle"].CollHashUpdates["_implicit_org_my-mspid"] = []*kvrwset.KVWriteHash{
						{KeyHash: util.ComputeSM3([]byte("namespaces/fields/chaincode-name#4/EndorsementInfo"))},
					}
				})
			...
			Context("when an existing chaincode definition with a package is updated", func() {
				...
				Context("by an approve event with an empty package ID for the current sequence number", func() {
					BeforeEach(func() {
						approvalTrigger.StateUpdates["_lifecycle"].CollHashUpdates["_implicit_org_my-mspid"] = []*kvrwset.KVWriteHash{
							{KeyHash: util.ComputeSM3([]byte("chaincode-sources/fields/chaincode-name#3/PackageID"))},
						}
					})
				...
				Context("by approve and commit events with an empty package ID for the next sequence number", func() {
					BeforeEach(func() {
						approvalTrigger.StateUpdates["_lifecycle"].CollHashUpdates["_implicit_org_my-mspid"] = []*kvrwset.KVWriteHash{
							{KeyHash: util.ComputeSM3([]byte("chaincode-sources/fields/chaincode-name#4/PackageID"))},
						}
