...
func TestNilValNoDeleteMarker(t *testing.T) {
	...
	testLedger.verifyPvtdataHashState("cc1", "coll1", "pvtKey1", util.ComputeSM3([]byte("pvtValue1")))
	testLedger.verifyPvtdataHashState("cc1", "coll1", "pvtKey2", util.ComputeSM3([]byte("pvtValue2")))
	...
	hashedWrites := &kvrwset.HashedRWSet{
		HashedWrites: []*kvrwset.KVWriteHash{
			{
				KeyHash:   util.ComputeSM3([]byte("pvtKey1")),
				IsDelete:  false,
				ValueHash: nil,
			},
			{
				KeyHash:   util.ComputeSM3([]byte("pvtKey2")),
				IsDelete:  false,
				ValueHash: util.ComputeSM3([]byte{}),
			},
		},
	}
				...
				CollectionHashedRwset: []*rwset.CollectionHashedReadWriteSet{
					{
						...
						PvtRwsetHash:   util.ComputeSM3(pvtWritesBytes),
					},
				},
			},
		},
